...
public class RotationTest1 
{
    ...
    MainFrame1 mf;
    int j=0;
    RotationTest1(MainFrame1 me,NuggetScore1 n1, double g2,int jj)
    {
        mf=me;
        ns=n1;        
        del=g2;
            ...
            for(int i=10;i<360;i+=10)
            {
                ...
                for(int k=0;k<mf.val[0].length;k++)
                {
                    if(k!=j)
                    {
                        ...
                        String Vj1[]=new String[ns.nf.Nval.length];
                        String Vk1[]=new String[ns.nf.Nval.length];
                        
                        String Vj2[]=new String[ns.nf.Nval.length];
                        String Vk2[]=new String[ns.nf.Nval.length];
                        
                        for(int t=0;t<ns.nf.Nval.length;t++)
                        {
                            Vj1[t]=String.valueOf(delX+Double.parseDouble(ns.nf.Nval[t][j]));
                            Vj2[t]=String.valueOf(Double.parseDouble(ns.nf.Nval[t][j])-delX);
                            //ns.nf.Nval1[j][t]=String.valueOf(delX+Double.parseDouble(ns.nf.Nval[j][t]));
                        }
                        for(int t=0;t<ns.nf.Nval.length;t++)
                        {
                            Vk1[t]=String.valueOf(delY+Double.parseDouble(ns.nf.Nval[t][j]));
                            Vk2[t]=String.valueOf(Double.parseDouble(ns.nf.Nval[t][j])-delY);
                            //ns.nf.Nval1[k][t]=String.valueOf(delY+Double.parseDouble(ns.nf.Nval[k][t]));
                        }
                        String Nval1[][]=new String[ns.nf.Nval.length][ns.nf.Nval[0].length-1];
                        String Nval2[][]=new String[ns.nf.Nval.length][ns.nf.Nval[0].length-1];
                        if(j<k)
                        {
                            for(int a1=0;a1<ns.nf.Nval.length;a1++)
                            {
                                for(int a2=0;a2<j-1;a2++)
                                {
                                    Nval1[a1][a2]=ns.nf.Nval[a1][a2];
                                    Nval2[a1][a2]=ns.nf.Nval[a1][a2];
                                }   
                                Nval1[a1][j]=Vj1[a1];                           
                                Nval2[a1][j]=Vj2[a1];    
                            }
                            ...
                            for(int a1=0;a1<ns.nf.Nval.length;a1++)
                            {
                                for(int a2=k;a2<ns.nf.Nval[0].length-1;a2++)
                                {
                                    Nval1[a1][a2]=ns.nf.Nval[a1][a2];
                                    Nval2[a1][a2]=ns.nf.Nval[a1][a2];
                                }                                        
                        ...
                        else
                        {
                            ...
                            for(int a1=0;a1<ns.nf.Nval.length;a1++)
                            {
                                for(int a2=j+1;a2<ns.nf.Nval[0].length-1;a2++)
                                {
                                    Nval1[a1][a2]=ns.nf.Nval[a1][a2];
                                    Nval2[a1][a2]=ns.nf.Nval[a1][a2];
                                }                                        
